...
class RayPPOTrainer(object):
    ...
    def __init__(self,
        ...
        # 如果 ref_in_actor 为True，则 reference policy 将使用未应用LoRA的actor模型
        self.ref_in_actor = config.actor_rollout_ref.model.get('lora_rank', 0) > 0
        if self.ref_in_actor:
            print("[INFO] LoRA mode detected: reference log-prob will be computed from the actor model without LoRA adapters.")
